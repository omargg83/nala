...
<form id='consulta_avanzada' is='f-submit' des='a_reporte/reporte7_res' dix='resultado'  autocomplete='off'>
  <div class='container' >
    <div class="alert alert-light" role="alert">
      <h4 class="alert-heading">GANANCIAS POR VENDEDOR</h4>
      <div class='row'>
      ...
      <div class='row'>
        <div class='col-xl col-auto'>
          <div class='btn-group'>
            ...
            <button type='button' class='btn btn-warning btn-sm'  id='print_persona' is='f-print' title='Editar' des='a_reporte/impganancias' dix='resultado'><i class='fas fa-print'></i>Imprimir</button>
