		  ...
		  <div class='collapse navbar-collapse' id='navbarSupportedContent'>
			...
			if($_SESSION['a_sistema']==1){
				if($db->nivel_captura==1){
					echo "<li class='nav-item active'><a class='nav-link barranav izq' is='a-link' title='Nuevo' id='new_personal' des='a_cliente/editar' v_id='0' dix='trabajo'><i class='fas fa-plus'></i><span>Nuevo</span></a></li>";
